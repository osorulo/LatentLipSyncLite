...
from ..utils.util import read_video, read_audio, write_video_o, check_ffmpeg_installed
...
class LipsyncPipeline(DiffusionPipeline):
    ...
    def restore_video(self, faces: torch.Tensor, video_frames: np.ndarray, boxes: list, affine_matrices: list):
        ...
        print(f"Restoring {len(faces)} faces frame by frame...")
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for i in range(num_inferences):
            ...
            total_inf = num_inference_steps * num_inferences
        ...
        write_video_o(video_out_path, video_gen, fps=video_fps)
