...
from .audio import SAMPLE_RATE, N_FRAMES, HOP_LENGTH, pad_or_trim, log_mel_spectrogram, log_mel_spectrogram2
...
def transcribe_text(
    ...
    **decode_options,
    ...
    mel = log_mel_spectrogram2(audio, model.dims.n_mels, padding=N_SAMPLES)
